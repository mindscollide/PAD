...
// Styles
import styles from "./UploadHeadOfComplianceTicketModal.module.css";
 ...
 */
const UploadHeadOfComplianceTicketModal = () => {
  // ===========================================================================
  // 🎯 HOOKS & CONTEXTS
  // ===========================================================================
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (uploadedFiles.length > 0) {
        ...
        if (saveResponse) {
          if (!isEscalatedHeadOfComplianceViewDetailData.ticketUploaded) {
            setIsEscalatedHeadOfComplianceViewDetailData((prev) => ({
              ...prev,
              ticketUploaded: true,
            }));
          }
...
export default UploadHeadOfComplianceTicketModal;
