 ...
 * opened by clicking a list row's Policy Count, backed by
 * GetHTAPolicyBreachDetailsAPI. Built to the actual SRS spec (Employee
 * ID + Employee Name header, Download button, Policy ID/Scenario/
 * Consequences as a real table, vertical scroll if it overflows) rather
 * than mirroring Admin's own version of this modal
 * (adminMain/reports/policyBreaches/PolicyBreachDetailsModal.jsx), which
 * is missing all four of those per
