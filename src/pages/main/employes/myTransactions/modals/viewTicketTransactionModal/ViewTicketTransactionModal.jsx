...
import { DocumentViewer, GlobalModal } from "./../../../../../../components";
...
const ViewTicketTransactionModal = () => {
          ...
          <Row gutter={[0, 0]}>
            <Col span={14}>
              <div className={styles.documentContainer}>
                <iframe
                  src={`data:application/pdf;base64,${sampleDoc.base64}#page=1`}
                  width="99%"
                  height="500px"
                />
              </div>
                  ...
                  >
                    <div className={styles.dropdownItem}>
                      <span className={styles.fileInfo}>
                        <img
                          src={
                            selectedIndex === index ? PDFVectorWhite : PDFVector
                          }
                          alt="PDF"
                          draggable={false}
                          width="26"
                      ...
                      <img
                        src={selectedIndex === index ? DownloadWhite : Download}
                        alt="Download"
                        draggable={false}
                        width="26"
                        height="26"
...
export default ViewTicketTransactionModal;
