...
import {
  ...
  warning,
  warning_default
} from "./chunk-3ANHQDE6.js";
import {
  require_react
} from "./chunk-GUKOQ7ZL.js";
import {
  require_classnames
} from "./chunk-N5YDICET.js";
import {
  __toESM
...
function genCSSMotion(config) {
  ...
  var CSSMotion = React12.forwardRef(function(props, ref) {
    ...
    var setNodeRef = React12.useCallback(function(node2) {
...
// node_modules/rc-notification/es/Notice.js
var Notify = React14.forwardRef(function(props, ref) {
  ...
  var _React$useState = React14.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), hovering = _React$useState2[0], setHovering = _React$useState2[1];
  var _React$useState3 = React14.useState(0), _React$useState4 = _slicedToArray(_React$useState3, 2), percent = _React$useState4[0], setPercent = _React$useState4[1];
  var _React$useState5 = React14.useState(0), _React$useState6 = _slicedToArray(_React$useState5, 2), spentTime = _React$useState6[0], setSpentTime = _React$useState6[1];
  ...
  var closableObj = React14.useMemo(function() {
  ...
  return React14.createElement("div", _extends({}, divProps, {
    ref,
  ...
  }, content), closable && React14.createElement("a", _extends({
    tabIndex: 0,
  ...
  }), closableObj.closeIcon), mergedShowProgress && React14.createElement("progress", {
...
var NotificationContext = import_react6.default.createContext({});
var NotificationProvider = function NotificationProvider2(_ref) {
  var children = _ref.children, classNames5 = _ref.classNames;
  return import_react6.default.createElement(NotificationContext.Provider, {
    value: {
...
var NoticeList = function NoticeList2(props) {
  ...
  var _useContext = (0, import_react7.useContext)(NotificationContext), ctxCls = _useContext.classNames;
  var dictRef = (0, import_react7.useRef)({});
  var _useState = (0, import_react7.useState)(null), _useState2 = _slicedToArray(_useState, 2), latestNotice = _useState2[0], setLatestNotice = _useState2[1];
  var _useState3 = (0, import_react7.useState)([]), _useState4 = _slicedToArray(_useState3, 2), hoverKeys = _useState4[0], setHoverKeys = _useState4[1];
  ...
  return import_react7.default.createElement(CSSMotionList_default, _extends({
    key: placement,
    ...
    }, import_react7.default.createElement(Notice_default, _extends({}, restConfig, {
...
// node_modules/rc-notification/es/Notifications.js
var Notifications = React17.forwardRef(function(props, ref) {
  ...
  var _React$useState = React17.useState([]), _React$useState2 = _slicedToArray(_React$useState, 2), configList = _React$useState2[0], setConfigList = _React$useState2[1];
  ...
  var _React$useState3 = React17.useState({}), _React$useState4 = _slicedToArray(_React$useState3, 2), placements = _React$useState4[0], setPlacements = _React$useState4[1];
  ...
  var emptyRef = React17.useRef(false);
  React17.useEffect(function() {
  ...
  return (0, import_react_dom2.createPortal)(React17.createElement(React17.Fragment, null, placementList.map(function(placement) {
    var placementConfigList = placements[placement];
    var list = React17.createElement(NoticeList_default, {
      key: placement,
...
function useNotification() {
  ...
  var _React$useState = React18.useState(), _React$useState2 = _slicedToArray(_React$useState, 2), container = _React$useState2[0], setContainer = _React$useState2[1];
  var notificationsRef = React18.useRef();
  var contextHolder = React18.createElement(Notifications_default, {
    container,
  ...
  var _React$useState3 = React18.useState([]), _React$useState4 = _slicedToArray(_React$useState3, 2), taskQueue = _React$useState4[0], setTaskQueue = _React$useState4[1];
  ...
  var api = React18.useMemo(function() {
    return {
      open,
      close: function close(key) {
        setTaskQueue(function(queue) {
...
// node_modules/antd/es/config-provider/hooks/useConfig.js
function useConfig() {
  const componentDisabled = (0, import_react13.useContext)(DisabledContext_default);
  const componentSize = (0, import_react13.useContext)(SizeContext_default);
  return {
    componentDisabled,
    componentSize
  };
...
function useUniqueMemo(memoFn, deps) {
  return import_react14.default.useMemo(function() {
...
function genStyleUtils(config) {
  ...
  function genCSSVarRegister(component, getDefaultToken, options) {
    ...
    var useCSSVar = function useCSSVar2(rootCls) {
      ...
      return [function(node2) {
        return injectStyle && cssVar ? import_react15.default.createElement(import_react15.default.Fragment, null, import_react15.default.createElement(CSSVarRegister, {
          rootCls,
          cssVar,
          component
        }), node2) : node2;
...
var style_default = genStyleHooks("Notification", (token2) => {
...
var TypeIcon = {
  info: React40.createElement(InfoCircleFilled_default, null),
  success: React40.createElement(CheckCircleFilled_default, null),
  error: React40.createElement(CloseCircleFilled_default, null),
  warning: React40.createElement(ExclamationCircleFilled_default, null),
  loading: React40.createElement(LoadingOutlined_default, null)
};
function getCloseIcon(prefixCls, closeIcon) {
  if (closeIcon === null || closeIcon === false) {
    return null;
  }
  return closeIcon || React40.createElement(CloseOutlined_default, {
...
var PureContent = (props) => {
  ...
  let iconNode = null;
  if (icon) {
    iconNode = React40.createElement("span", {
      className: `${prefixCls}-icon`
    }, icon);
  } else if (type) {
    iconNode = React40.createElement(typeToIcon[type] || null, {
      className: (0, import_classnames4.default)(`${prefixCls}-icon`, `${prefixCls}-icon-${type}`)
    });
  }
  return React40.createElement("div", {
    ...
    role
  }, iconNode, React40.createElement("div", {
    className: `${prefixCls}-message`
  }, message), React40.createElement("div", {
    className: `${prefixCls}-description`
  }, description), actions && React40.createElement("div", {
...
var PurePanel = (props) => {
  ...
  } = props, restProps = __rest4(props, ["prefixCls", "className", "icon", "type", "message", "description", "btn", "actions", "closable", "closeIcon", "className"]);
  const {
    getPrefixCls
  } = React40.useContext(ConfigContext);
  const mergedActions = actions !== null && actions !== void 0 ? actions : btn;
  if (true) {
    const warning3 = devUseWarning("Notification");
  ...
  return wrapCSSVar(React40.createElement("div", {
    className: (0, import_classnames4.default)(`${noticePrefixCls}-pure-panel`, hashId, className, cssVarCls, rootCls)
  }, React40.createElement(pure_panel_default, {
    prefixCls
  }), React40.createElement(Notice_default, Object.assign({}, restProps, {
    prefixCls,
    eventKey: "pure",
    duration: null,
    closable,
    ...
    content: React40.createElement(PureContent, {
...
var Wrapper = ({
  ...
  const rootCls = useCSSVarCls_default(prefixCls);
  const [wrapCSSVar, hashId, cssVarCls] = style_default(prefixCls, rootCls);
  return wrapCSSVar(import_react20.default.createElement(NotificationProvider_default, {
    classNames: {
      list: (0, import_classnames5.default)(hashId, cssVarCls, rootCls)
    }
  }, children));
};
var renderNotifications = (node2, {
  prefixCls,
  key
}) => import_react20.default.createElement(Wrapper, {
  prefixCls,
  key
}, node2);
var Holder = import_react20.default.forwardRef((props, ref) => {
  const {
    top,
    bottom,
    prefixCls: staticPrefixCls,
  ...
  const [, token2] = useToken();
  const prefixCls = staticPrefixCls || getPrefixCls("notification");
  const getStyle2 = (placement) => getPlacementStyle(placement, top !== null && top !== void 0 ? top : DEFAULT_OFFSET2, bottom !== null && bottom !== void 0 ? bottom : DEFAULT_OFFSET2);
  const getClassName = () => (0, import_classnames5.default)({
  ...
  import_react20.default.useImperativeHandle(ref, () => Object.assign(Object.assign({}, api), {
    prefixCls,
    notification
  }));
  return holder;
...
function useInternalNotification(notificationConfig) {
  ...
  const wrapAPI = import_react20.default.useMemo(() => {
    const open = (config) => {
      ...
      const {
        ...
        closeIcon,
        closable
      } = config, restConfig = __rest5(config, ["message", "description", "icon", "type", "btn", "actions", "className", "style", "role", "closeIcon", "closable"]);
      if (true) {
        warning3.deprecated(!btn, "btn", "actions");
      }
      const mergedActions = actions !== null && actions !== void 0 ? actions : btn;
      ...
      return originOpen(Object.assign(Object.assign({
        ...
        content: import_react20.default.createElement(PureContent, {
          prefixCls: noticePrefixCls,
          icon,
          type,
          message,
        ...
        className: (0, import_classnames5.default)(type && `${noticePrefixCls}-${type}`, className, notification === null || notification === void 0 ? void 0 : notification.className),
  ...
  return [wrapAPI, import_react20.default.createElement(Holder, Object.assign({
...
//# sourceMappingURL=chunk-XJLG5EMC.js.map
